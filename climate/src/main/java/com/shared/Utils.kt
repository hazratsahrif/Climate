...
//                            txtTemperature.text = "$inF°"
    ...
    private fun fahrenheitToCelsius(fahrenheit: Int): Double {
     ...
     fun switchLayout(
        ...
        leftIndex: Int,
        rightIndex: Int,
        layoutL:LinearLayout,
        layoutR:LinearLayout
    ) {
//        val layoutLeft = layoutL
//        val layoutRight = layoutR
        parentLayout.removeView(layoutL)
        parentLayout.removeView(layoutR)

        // Adding the layouts in the reversed order
        parentLayout.addView(layoutR, leftIndex)
        parentLayout.addView(layoutL, rightIndex)
    }
}